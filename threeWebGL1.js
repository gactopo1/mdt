...
export function inicializarEscena(canvas,vertices) {
    ...
    // Crear una geometría y agregarla a la escena
    ...
    const directionalLight = new THREE.DirectionalLight(0xffffff, rangoLuzD);
...
function animate() {
    ...
    if (renderer) renderer.render(escena, camara);
}
